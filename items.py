...
SHOP_SKILLS = {
    ...
    "assassin_skill_4": {
        "name": "🕷️ Shadow Web",
        "desc": "Jebak musuh dalam jaring bayangan, 2.6x DMG + imobilisasi 2 ronde",
        "class": "assassin",
        "price": 21000,
        "rarity": "epic",
        "effect": {"dmg_mult": 2.6, "stun_duration": 2, "mp_cost": 50, "cooldown": 5},
        "lore": "Jaring kegelapan yang menahan pergerakan musuh, memudahkan serangan berikutnya.",
    },
    "assassin_skill_5": {
        "name": "☠️ Deathblow",
        "desc": "Serangan rahasia terkuat, 6x DMG jika musuh di bawah 50% HP",
        "class": "assassin",
        "price": 45000,
        "rarity": "legendary",
        "effect": {"dmg_mult": 6.0, "execute_threshold": 0.5, "mp_cost": 85, "cooldown": 9},
