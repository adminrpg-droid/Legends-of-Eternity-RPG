...
from database import is_admin, is_super_admin, get_player, get_all_players
...
async def _check_vote_result(context, delay: float):
    ...
    # Jika suara setuju lebih banyak → perang diterima
    if yes_votes > no_votes:
        ...
        reason = "ditolak mayoritas" if no_votes >= yes_votes else "tidak cukup suara"
        result_text = (
            f"╔══════════════════════════════════╗\n"
